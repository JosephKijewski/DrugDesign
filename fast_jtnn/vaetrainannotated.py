...
#Molecule dataset is a class in datautils.py. opts.train_path is basically the path
#which I believe is passed in as an argument to the program. It then opens the file
#and lets self.data (dataset.data) be a list of the smiles strings I believe.
...
for epoch in xrange(MAX_EPOCH):
    #I believe what dataloader does is take in a class that has get_item. Then get_item
    #is called by dataloader. MoleculeDatasets get_item transitions smiles into mol_trees
    #, so when dataloader loads them in they come as trees.
    ...
    #I believe it means iteration, so the number batch you are on. batch I believe is just
    #the batch.
