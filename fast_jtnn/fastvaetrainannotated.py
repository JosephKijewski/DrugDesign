...
for epoch in xrange(args.epoch):
    #MolTreeFolder will load the batched data. It has an __iter__ function that allows
    #you to loop and iterate through it. The behavior is as defined in the __iter__ 
    #function in the file with MolTreeFolder
    loader = MolTreeFolder(args.train, vocab, args.batch_size, num_workers=4)
    for batch in loader:
        total_step += 1
        try:
            model.zero_grad()
            #I'm confused how model(batch, beta) works here as if its a static function,
            #but in pytorch, this is how you predict stuff, or get some sort of output.
